...
export default {
	async fetch(
		...
		/**
		 * Wiki en modo manual: lectura del estado y de artículos ya publicados.
		 * La generación automática está desactivada. No hay Cron, consumidor de Queue
		 * ni endpoint público que alimente trabajos.
		 */
		/**
